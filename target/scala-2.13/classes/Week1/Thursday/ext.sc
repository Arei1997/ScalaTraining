...
// can also use slice? less efficient because it traverses the list
...
// comparing a set and a set cannot work even if they contain same elements as they are different data structures. logically they cant be equated as a set has no indexing and a list does
